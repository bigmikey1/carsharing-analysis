...
DATEI = "Daten\\Buchungen (Export)\\Buchungen 2025\\Buchungen_04-06_25_raw.csv"

from Quartalsergebnis_Q1_26 import GUELTIGE_TARIFE

GUELTIGE_MONATE = ["2025-04", "2025-05", "2025-06"]
...
# ── Bereinigung ─────────────────────────────────────────────
    ...
    # ── CSV-Exports ─────────────────────────────────────────────
    stationen_df.to_csv(
        "Auswertung_Stationsnamen_Q2_2025.csv",
        index=False
    )

    gesamt_q2_df.to_csv(
        "Auswertung_Gesamtsumme_Q2_2025.csv",
        index=False
    )
print("Auswertung_Stationsnamen_Q2_2025.csv")
print("Auswertung_Gesamtsumme_Q2_2025.csv")
