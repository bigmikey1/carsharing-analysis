...
DATEI = "Daten\\Buchungen (Export)\\Buchungen 2025\\Buchungen_10-12_25_raw.csv"

from Quartalsergebnis_Q1_26 import GUELTIGE_TARIFE

GUELTIGE_MONATE = ["2025-10", "2025-11", "2025-12"]
...
# ── Bereinigung ─────────────────────────────────────────────
    ...
    # ── CSV-Exports ─────────────────────────────────────────────
    stationen_df.to_csv(
        "Auswertung_Stationsnamen_Q4_2025.csv",
        index=False
    )

    gesamt_q4_df.to_csv(
        "Auswertung_Gesamtsumme_Q4_2025.csv",
        index=False
    )
print("Auswertung_Stationsnamen_Q4_2025.csv")
print("Auswertung_Gesamtsumme_Q4_2025.csv")
